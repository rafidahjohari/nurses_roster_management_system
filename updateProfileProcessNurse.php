...
if (isset($_POST['update_profile'])) {
    ...
    if ($new_pass2 != $new_pass1) {
        ...
        echo "<meta http-equiv='refresh' content='0; url=updateProfileNurse.php'/>";
    } else {
        $update_profile = "update nurses set nursesName = '$new_name', nursesPhoneNo = '$new_phone', nursesEmail = '$new_email', nursesPassword = '$new_pass2' WHERE nursesID = '$user_id'";
        ...
        if ($run_profile) {
            ...
            echo "<meta http-equiv='refresh' content='0; url=nursesMain.php'/>";
        } else {
